...
The **IBM Power Systems VIOS collection** contains modules that can be used in a playbook
to automate tasks on VIOS. Ansible executes each module on the target node and
