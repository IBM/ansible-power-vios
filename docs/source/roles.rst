...
The **IBM Power Systems VIOS collection** contains roles that can be used in a playbook
to automate tasks on VIOS. Ansible executes each role, usually on the remote target node,
