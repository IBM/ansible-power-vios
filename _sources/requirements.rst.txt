...
However, you cannot run **IBM Power Systems VIOS collection** on a Windows system.
...
* `Python on VIOS`_: 2.7 or later
* `VIOS OS`_: 2.2.5 or later
* `VIOS OpenSSH`_
...
and GNU software built for IBM Power Systems AIX & VIOS (including Python).
